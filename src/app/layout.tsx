...
export const metadata: Metadata = {
  title: "Serenity Pilates | Mindful Movement & Wellness Studio",
  description: "Transform your body and mind with personalized pilates classes. Expert instructors, flexible memberships, and a welcoming community await.",
  keywords: ["pilates studio", "mat pilates", "reformer pilates", "fitness classes", "wellness"],
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Serenity Pilates Studio",
    description: "Find your inner balance through expert pilates training and mindful movement",
    siteName: "Serenity Pilates",
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "Serenity Pilates Studio",
    description: "Transform through pilates",
  },
};
